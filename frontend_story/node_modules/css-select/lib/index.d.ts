import type { CompiledQuery, Options, Query, Adapter } from "css-select/src/types";
export type { Options };
/**
...
export declare const _compileToken: <Node_1, ElementNode extends Node_1>(selector: import("css-select/src/types").InternalSelector[][], options?: Options<Node_1, ElementNode> | undefined, context?: Node_1 | Node_1[] | undefined) => CompiledQuery<ElementNode>;
...
export { filters, pseudos, aliases } from "css-select/src/pseudo-selectors";
